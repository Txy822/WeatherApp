...
This is a simple coding challenge to illustrate how to use clean code architecture, dependency injection, MVVM, Compose,  and other tools to develop  Android  apps. 
The app simply displays London weather weekly and hourly basis. 
